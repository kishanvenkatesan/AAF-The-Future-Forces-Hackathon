...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welecome to Cornado</h4>
...
<div class="col">
    <div class="row" style="padding: 22px;padding-top: 0">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/loan.jpg" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
          <a href="loan.php" class="btn btn-outline-success btn-block">Apply for loan</a>
         </div>
        </div>
      </div>
    </div>
